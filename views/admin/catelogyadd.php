        ...
        <div class="pd-content mt-40">
            <div class="row">
                <div class="col-6">
                    ...
                    <input type="text" name="ten_loai" id="" class="form-control w-100" placeholder="Please type catelogy name">
                </div>
                <div class="col-6">
                    <label for="" class="form-label h2 mb-2">Number</label>
                    <input type="number" name="thutu" id="" class="form-control w-100">
                </div>
            </div>
            <div class="row mt-3">
                <div class="col-6">
