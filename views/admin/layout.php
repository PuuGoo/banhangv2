...
<head>
    ...
    <link rel="stylesheet" href="<?= PUBLIC_URL ?>css/admin/<?= explode("/", explode(".", $contentView)[0])[2] ?>.css?v=<?php echo time(); ?>">
</head>

<body class="banhang-fixed-top bh-fixed-top">

    <?php if ($contentView !== "views/admin/login.php") : ?>
        <header class="bh-header navbar navbar-expand bg-dark">
            ...
            <div class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-menu-end">
                    ...
                    <li><a href="<?= ROOT_URL . "admin/logout" ?>" class="dropdown-item">Logout</a></li>
                </ul>
            </div>
